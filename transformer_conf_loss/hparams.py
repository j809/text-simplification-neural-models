...
class Hparams:
    ...
    parser.add_argument('--ppdb_rules', default='/mnt/nfs/work1/cs696e/krajbhara/project/transformer_conf_loss/simplification-dictionary', help="simple ppdb dictionary file")
    ## vocabulary
    ...
    parser.add_argument('--confidence_rate', default=0.2, type=float,
    ...
    parser.add_argument('--ckpt', default='/mnt/nfs/work1/cs696e/krajbhara/project/transformer_conf_loss/log/1/', help="checkpoint file path")
